...
//}
//
//std::vector<Node*> PathFinder::BFS(const Graph& graph_, NodeRenderData& renderData_, int speedMillis_)
//{
...
//		}
//
//		std::this_thread::sleep_for(std::chrono::milliseconds(speedMillis_));
//	}
//
//	return masterList.Path(currentNode);
//}
//
//std::vector<Node*> PathFinder::DFS(const Graph& graph_, NodeRenderData& renderData_, int speedMillis_)
//{
//	//add all nodes in graph to a PF_NodeQueue
//	PF_NodeQueue masterList;
//	PF_NodeQueue openList;
...
//	{
//		//openList.Sort();
//		currentNode = openList.RemoveLastElem();
//		renderData_.currentNode = currentNode.node;
//		if (currentNode.node == graph_.EndNode())
//			break;
//
...
//}
//
//std::vector<Node*> PathFinder::Dijkstras(const Graph& graph_, NodeRenderData& renderData_, int speedMillis_)
//{
//	//add all nodes in graph to a PF_NodeQueue
//	PF_NodeQueue masterList;
//	PF_NodeQueue openList;
...
//}
//
//std::vector<Node*> PathFinder::AStar(const Graph& graph_, NodeRenderData& renderData_, int speedMillis_)
//{
//	//add all nodes in graph to a PF_NodeQueue
//	PF_NodeQueue masterList;
//	PF_NodeQueue openList;
